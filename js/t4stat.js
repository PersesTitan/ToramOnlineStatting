...
const OPTIONS = [
    { "name": "STR", "mat": "짐승", "pot": 5, "cost": 25, "cat": "Enhance Stats", "type": "u", bonus: 1},
    { "name": "STR %", "mat": "짐승", "pot": 10, "cost": 50, "cat": "Enhance Stats", "type": "u" },
    { "name": "INT", "mat": "목재", "pot": 5, "cost": 25, "cat": "Enhance Stats", "type": "u", bonus: 1},
    { "name": "INT %", "mat": "목재", "pot": 10, "cost": 50, "cat": "Enhance Stats", "type": "u" },
    { "name": "VIT", "mat": "금속", "pot": 5, "cost": 25, "cat": "Enhance Stats", "type": "u" , bonus: 1},
    { "name": "VIT %", "mat": "금속", "pot": 10, "cost": 50, "cat": "Enhance Stats", "type": "u" },
    { "name": "AGI", "mat": "천", "pot": 5, "cost": 25, "cat": "Enhance Stats", "type": "u", bonus: 1 },
    { "name": "AGI %", "mat": "천", "pot": 10, "cost": 50, "cat": "Enhance Stats", "type": "u" },
    { "name": "DEX", "mat": "약품", "pot": 5, "cost": 25, "cat": "Enhance Stats", "type": "u", bonus: 1},
    { "name": "DEX %", "mat": "약품", "pot": 10, "cost": 50, "cat": "Enhance Stats", "type": "u" },

    { "name": "자연 HP회복", "mat": "금속", "pot": 5, "cost": 25, "cat": "Enhance HP/MP", "type": "a", bonus: 1},
    { "name": "자연 HP회복 %", "mat": "금속", "pot": 10, "cost": 50, "cat": "Enhance HP/MP", "type": "a"},
    { "name": "자연 MP회복", "mat": "목재", "pot": 10, "cost": 50, "cat": "Enhance HP/MP", "type": "a" , bonus: 1, bonusratio: 0.5 },
    { "name": "자연 MP회복 %", "mat": "목재", "pot": 20, "cost": 100, "cat": "Enhance HP/MP", "type": "a" },
    { "name": "MaxHP", "mat": "금속", "pot": 3, "cost": "16.49", "cat": "Enhance HP/MP", "type": "u", bonus: 160, step: 10 },
    { "name": "MaxHP %", "mat": "금속", "pot": 10, "cost": 50, "cat": "Enhance HP/MP", "type": "u", bonus: 1, bonusratio: 1 / 3},
    { "name": "MaxMP", "mat": "목재", "pot": 6, "cost": "33.49", "cat": "Enhance HP/MP", "type": "u", max: 15, max_only: true, step: 10, bonus: 10, bonusratio: 0.5 },

    { "name": "ATK", "mat": "짐승", "pot": 3, "cost": "16.49", "cat": "Enhance Attack", "type": "w", bonus: 1 },
    { "name": "ATK %", "mat": "짐승", "pot": 10, "cost": 50, "cat": "Enhance Attack", "type": "w", bonus: 1, bonusratio: 0.5 },
    ...
    { "name": "MDEF", "mat": "금속", "pot": 3, "cost": "16.49", "cat": "Enhance Defense", "type": "a", bonus: 10 },
    { "name": "MDEF %", "mat": "금속", "pot": 10, "cost": 50, "cat": "Enhance Defense", "type": "a", bonus: 1, bonusratio: 1 / 3 },
    { "name": "물리내성 %", "mat": "금속", "pot": 10, "cost": 50, "cat": "Enhance Defense", "type": "a", bonus: 1, bonusratio: 1 / 3 },
    { "name": "마법내성 %", "mat": "목재", "pot": 10, "cost": 50, "cat": "Enhance Defense", "type": "a", bonus: 1, bonusratio: 1 / 3 },

    { "name": "주위경감 %", "mat": "금속", "pot": 6, "cost": 15, "cat": "Enhance Defense", "type": "a", nonega: true, max: BONUS_STEPS },
    { "name": "범위경감 %", "mat": "금속", "pot": 6, "cost": 15, "cat": "Enhance Defense", "type": "a", nonega: true, max: BONUS_STEPS },
    { "name": "직선경감 %", "mat": "목재", "pot": 6, "cost": 15, "cat": "Enhance Defense", "type": "a", nonega: true, max: BONUS_STEPS },
    { "name": "돌진경감 %", "mat": "목재", "pot": 6, "cost": 15, "cat": "Enhance Defense", "type": "a", nonega: true, max: BONUS_STEPS },
    { "name": "운석경감 %", "mat": "목재", "pot": 4, "cost": 15, "cat": "Enhance Defense", "type": "a", nonega: true, max: BONUS_STEPS },
    { "name": "탄환경감 %", "mat": "목재", "pot": 4, "cost": 15, "cat": "Enhance Defense", "type": "a", nonega: true, max: BONUS_STEPS },
    { "name": "사인경감 %", "mat": "목재", "pot": 4, "cost": 15, "cat": "Enhance Defense", "type": "a", nonega: true, max: BONUS_STEPS },
    ...
    { "name": "ASPD %", "mat": "천", "pot": 1, "cost": 5, "cat": "Enhance Speed", "type": "u" },
    { "name": "CSPD", "mat": "약품", "pot": 1, "cost": "1.49", "cat": "Enhance Speed", "type": "u", bonus: 16 },
    { "name": "CSPD %", "mat": "약품", "pot": 1, "cost": 5, "cat": "Enhance Speed", "type": "u" },

    { "name": "크리티컬 확률 +", "mat": "마소", "pot": 1, "cost": 5, "cat": "Enhance Critical", "type": "u", bonus: 1, max_only: true },
    { "name": "크리티컬 확률 %", "mat": "마소", "pot": 1, "cost": 5, "cat": "Enhance Critical", "type": "u", bonus: 1, max_only: true },
    { "name": "크리티컬 데미지 +", "mat": "마소", "pot": 3, "cost": "16.49", "cat": "Enhance Critical", "type": "u", bonus: 1, bonusratio: 1 / 3 },
    { "name": "크리티컬 데미지 %", "mat": "마소", "pot": 10, "cost": 50, "cat": "Enhance Critical", "type": "u" },

    { "name": "불 속성에 %유리", "mat": "마소", "pot": 5, "cost": 25, "cat": "Enhance Elements", "type": "w", bonus: 1, bonusratio: 1 / 3  },
    { "name": "물 속성에 %유리", "mat": "마소", "pot": 5, "cost": 25, "cat": "Enhance Elements", "type": "w", bonus: 1, bonusratio: 1 / 3  },
    { "name": "바람 속성에 %유리", "mat": "마소", "pot": 5, "cost": 25, "cat": "Enhance Elements", "type": "w", bonus: 1, bonusratio: 1 / 3  },
    ...
    { "name": "바람 속성", "mat": "마소", "pot": 100, "cost": 150, "cat": "Awaken Elements", "type": "e", max: 1, nonega: true },
    { "name": "땅 속성", "mat": "마소", "pot": 100, "cost": 150, "cat": "Awaken Elements", "type": "e", max: 1, nonega: true },
    { "name": "빛 속성", "mat": "마소", "pot": 100, "cost": 150, "cat": "Awaken Elements", "type": "e", max: 1, nonega: true },
    { "name": "어둠 속성", "mat": "마소", "pot": 100, "cost": 150, "cat": "Awaken Elements", "type": "e", max: 1, nonega: true },
    { "name": "불 속성 (일치)", "mat": "마소", "pot": 10, "cost": 150, "cat": "Awaken Elements", "type": "e", max: 1, nonega: true },
    { "name": "물 속성 (일치)", "mat": "마소", "pot": 10, "cost": 150, "cat": "Awaken Elements", "type": "e", max: 1, nonega: true },
    { "name": "바람 속성 (일치)", "mat": "마소", "pot": 10, "cost": 150, "cat": "Awaken Elements", "type": "e", max: 1, nonega: true },
    { "name": "땅 속성 (일치)", "mat": "마소", "pot": 10, "cost": 150, "cat": "Awaken Elements", "type": "e", max: 1, nonega: true },
    { "name": "빛 속성 (일치)", "mat": "마소", "pot": 10, "cost": 150, "cat": "Awaken Elements", "type": "e", max: 1, nonega: true },
    { "name": "어둠 속성 (일치)", "mat": "마소", "pot": 10, "cost": 150, "cat": "Awaken Elements", "type": "e", max: 1, nonega: true },
];
...
class Slot {
    ...
    buildDisplay() {
        let buffer = `<select id="slot${this.slot_num}" onchange="App.getCurrent().slots[${this.slot_num}].onUpdate()"><option value=0>선택해주세요.</option>`;
        let last_cat = '';
        let cat_id = 0;
...
class Stat {
    constructor(details) {
        ...
        this.mats = { 금속: 0, 천: 0, 짐승: 0, 목재: 0, 약품: 0, 마소: 0 };
        this.step_mats = { 금속: 0, 천: 0, 짐승: 0, 목재: 0, 약품: 0, 마소: 0 };
    ...
    updatePotentialSuccessDisplay() {
        document.getElementById('potential_display').innerHTML = `잠재력: ${this.future_pot} / ${this.pot}`;
        document.getElementById('success_rate_display').innerHTML = `확률: ${this.getSuccessRate()}%`;
        document.getElementById('confirm_button').disabled = this.pot === this.future_pot;
    }

    updateMaterialCosts() {
        let buffer = `<table style="width: 100%"><tr><th style="width: 30%; text-align: left">소재</th><th style="text-align: left">사용량</th></tr>`
        for (let mat in this.mats) {
            buffer += `<tr><td>${mat}</td><td>${this.mats[mat]}</td></tr>`;
        }
        buffer += `<tr><th style="text-align: left">최대 사용량</th><td>${this.max_mats}</td></tr></table>`
    ...
    updateFormulaDisplay() {
        ...
        if (typeof this.finished === 'number') {
            display += `<br />확률: ${this.getSuccessRate()}%`;
        ...
        document.getElementById('formula_display').innerHTML = `<span style="font-weight: bold; font-size: 12pt;">단계</span><br /><br />${this.type === 'w' ? '무기' : '옷'} - 잠재력: ${this.starting_pot}<br />${display}`;
    ...
    loadDisplay() {
        ...
        const confirm = `<button onclick="App.getCurrent().confirm()" id='confirm_button' disabled>추가</button>`;
        const repeat = `<button id="repeat_button" onclick="App.getCurrent().repeat()" disabled>반복</button>`;
        const undo = `<button onclick="App.getCurrent().undo()" disabled id="undo_button">취소</button>`;
        const redo = `<button onclick="App.getCurrent().redo()" disabled id="redo_button">되돌리기</button>`;

        const display = `<table><tr><td style="text-align: center" id='potential_display'>잠재력: ${potential}</td></tr><tr><td>${buffer}</td></tr><tr><td style="text-align: center" id="success_rate_display">확률: ${this.getSuccessRate()}%</td></tr><tr><td style="text-align: center">${confirm} ${repeat} ${undo} ${redo}</td></tr></table>`;
